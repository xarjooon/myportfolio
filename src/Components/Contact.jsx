    ...
    className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center '>
                <form action="https://getform.io/f/Pe9l68dL" method='POST' className='flex flex-col w-full md:w-1/2'>
                    <input type="text" name='' placeholder='Enter your Name ' className='p-2 bg-transparent border-2 *:rounded-md
                     ...
                     <textarea name="message"  placeholder='Enter your message ' rows="10" className='p-2 bg-transparent border-2 *:rounded-md
                      ...
                      items-center rounded-md hover:scale-110 duration-500'>Let's talk!</button>
                </form>
            </div>
        </div>
    </div>
